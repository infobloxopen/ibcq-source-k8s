...
- **FR-007**: System MUST use `uid` as the primary key for the `k8s_custom_resources` table
- **FR-008**: System MUST support wildcard patterns for group, version, and kind (e.g., `*.cert-manager.io/*/*`)
