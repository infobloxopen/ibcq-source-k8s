...
* **custom-resources:** Add support for collecting arbitrary Kubernetes Custom Resources ([#XXX](https://github.com/Infoblox-CTO/cloudquery/issues/XXX))
  - New `k8s_custom_resources` table for storing custom resources (CloudQuery-compatible schema)
  - Configure custom resources via `custom_resources` in spec with GVK format `"group/version/kind"`
  - Schema matches CloudQuery official k8s plugin:
    - Split `api_version` and `kind` fields (instead of combined GVK)
    - JSONB columns for `labels`, `annotations`, `spec`, `status`, `owner_references`
    - Text array for `finalizers`
    - Primary key on `uid` with deterministic `_cq_id`
...
* Align wording and description with current licensing ([#18371](https://github.com/Infoblox-CTO/cloudquery/issues/18371)) ([ba91d48](https://github.com/Infoblox-CTO/cloudquery/commit/ba91d4823e4a805620650ff0a82ba44387b7d979))
* **deps:** Update golang.org/x/exp digest to 7f521ea ([#18428](https://github.com/Infoblox-CTO/cloudquery/issues/18428)) ([5d18290](https://github.com/Infoblox-CTO/cloudquery/commit/5d1829066fa91705ea83ecc6d212b7e64704860d))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.45.6 ([#18340](https://github.com/Infoblox-CTO/cloudquery/issues/18340)) ([f284668](https://github.com/Infoblox-CTO/cloudquery/commit/f284668c7912ce7191cc5d70f11135874f7d98c9))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.46.0 ([#18341](https://github.com/Infoblox-CTO/cloudquery/issues/18341)) ([5db9574](https://github.com/Infoblox-CTO/cloudquery/commit/5db9574defbd47b798254dacb1f4e466ccfacf74))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.46.1 ([#18350](https://github.com/Infoblox-CTO/cloudquery/issues/18350)) ([8ff8909](https://github.com/Infoblox-CTO/cloudquery/commit/8ff89094c231abfbc1cec38f8901a546139f2d01))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.47.0 ([#18351](https://github.com/Infoblox-CTO/cloudquery/issues/18351)) ([9c5bbdc](https://github.com/Infoblox-CTO/cloudquery/commit/9c5bbdccebdc2c65df491f70f76483aa0bb1c533))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.47.1 ([#18352](https://github.com/Infoblox-CTO/cloudquery/issues/18352)) ([b31812a](https://github.com/Infoblox-CTO/cloudquery/commit/b31812a821233cffa2b9bbc6a7644797f380fa82))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.48.0 ([#18363](https://github.com/Infoblox-CTO/cloudquery/issues/18363)) ([61baf97](https://github.com/Infoblox-CTO/cloudquery/commit/61baf97d1704878dcb129be56bd6457109b1719a))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.49.0 ([#18415](https://github.com/Infoblox-CTO/cloudquery/issues/18415)) ([3f4ef53](https://github.com/Infoblox-CTO/cloudquery/commit/3f4ef5366078eebd38ab7c1cc52afc0eaeee08f4))
* **deps:** Update module github.com/hashicorp/go-retryablehttp to v0.7.7 [SECURITY] ([#18369](https://github.com/Infoblox-CTO/cloudquery/issues/18369)) ([1e223bf](https://github.com/Infoblox-CTO/cloudquery/commit/1e223bf58529449ab7b30d1a0d046a40a0488cf1))
...
* Remove logging of error events to Sentry in plugins ([#18165](https://github.com/Infoblox-CTO/cloudquery/issues/18165)) ([fc4ff27](https://github.com/Infoblox-CTO/cloudquery/commit/fc4ff27d37f9250b4cf912474073169406cb01fa))


### Bug Fixes

* **deps:** Update module github.com/docker/docker to v26.1.3+incompatible ([#18083](https://github.com/Infoblox-CTO/cloudquery/issues/18083)) ([c1c3754](https://github.com/Infoblox-CTO/cloudquery/commit/c1c375447429487083baab6a56b27303890321e7))

## [6.0.17](https://github.com/Infoblox-CTO/cloudquery/compare/plugins-source-k8s-v6.0.16...plugins-source-k8s-v6.0.17) (2024-06-03)
...
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.39.1 ([#17760](https://github.com/Infoblox-CTO/cloudquery/issues/17760)) ([7f6faad](https://github.com/Infoblox-CTO/cloudquery/commit/7f6faad99e6678d17d449d0da18e0340a2537848))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.40.0 ([#17796](https://github.com/Infoblox-CTO/cloudquery/issues/17796)) ([1622575](https://github.com/Infoblox-CTO/cloudquery/commit/1622575f1eb776cafc637573010fd66f85877079))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.40.1 ([#17865](https://github.com/Infoblox-CTO/cloudquery/issues/17865)) ([a532364](https://github.com/Infoblox-CTO/cloudquery/commit/a532364842076cbfadbf146ab18634607a693ddf))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.41.0 ([#17917](https://github.com/Infoblox-CTO/cloudquery/issues/17917)) ([81f2506](https://github.com/Infoblox-CTO/cloudquery/commit/81f25061a461a025595aa0b4ed4bf992f53e67be))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.41.1 ([#17941](https://github.com/Infoblox-CTO/cloudquery/issues/17941)) ([b112a67](https://github.com/Infoblox-CTO/cloudquery/commit/b112a6798245d12ef82da532504a500c610cac10))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.42.0 ([#17951](https://github.com/Infoblox-CTO/cloudquery/issues/17951)) ([f5befb1](https://github.com/Infoblox-CTO/cloudquery/commit/f5befb1fba1089d78c594c39064466795c53a86e))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.42.1 ([#17965](https://github.com/Infoblox-CTO/cloudquery/issues/17965)) ([d652b81](https://github.com/Infoblox-CTO/cloudquery/commit/d652b81e18a35d122280ee1e59c601d7b1a0e607))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.42.2 ([#18000](https://github.com/Infoblox-CTO/cloudquery/issues/18000)) ([5fc0f46](https://github.com/Infoblox-CTO/cloudquery/commit/5fc0f46ce912a6b5c1d232b405ca6f2a30584461))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.43.0 ([#18014](https://github.com/Infoblox-CTO/cloudquery/issues/18014)) ([20592c8](https://github.com/Infoblox-CTO/cloudquery/commit/20592c8ba2a2da05a6dac60701e821fc0623bf60))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.43.1 ([#18026](https://github.com/Infoblox-CTO/cloudquery/issues/18026)) ([364307c](https://github.com/Infoblox-CTO/cloudquery/commit/364307c5a7e954cc3521498678e3aa658eb4937a))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.44.1 ([#18076](https://github.com/Infoblox-CTO/cloudquery/issues/18076)) ([7cd7012](https://github.com/Infoblox-CTO/cloudquery/commit/7cd70128389844d0221f7dce7102375f8931ef77))
* **deps:** Update module github.com/cloudquery/plugin-sdk/v4 to v4.44.2 ([#18113](https://github.com/Infoblox-CTO/cloudquery/issues/18113)) ([508347b](https://github.com/Infoblox-CTO/cloudquery/commit/508347b8d2168564f69ccb33171f290267647c12))
* **deps:** Upgrade `github.com/apache/arrow/go` to `v16` ([#17889](https://github.com/Infoblox-CTO/cloudquery/issues/17889)) ([98b2634](https://github.com/Infoblox-CTO/cloudquery/commit/98b2634b1295f0a071acc5146e7672b7d22e316b))
